export function Comparison() {
    return (
        <div className="flex flex-col justify-center items-center py-10 min-h-[80vh]">
            ...
            <div className="flex flex-col md:flex-row max-w-3xl lg:max-w-4xl w-[70%] md:w-full space-y-4 md:space-y-0">
                <div className="flex-1 p-6 border rounded-xl">
                    <h3 className="text-[--color-primary] text-center text-2xl font-bold mb-2">DreamNotes</h3>
                ...
                <div className="flex-1 p-6 border rounded-xl">
                    <h3 className="text-[--color-primary] text-center text-2xl font-bold mb-2">Métodos tradicionais</h3>
